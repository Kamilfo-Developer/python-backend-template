...
from app.lib.enums.filter import FilterType, IntervalUnit
from app.lib.utils.filter import inclusion_filter
...
def wrap_field(field_info: Any) -> Any:
    ...
    Examples:
        ...
        >>> from app.lib.schemas.fields import wrap_field
        >>>
...
INTERVAL_VALUE = BaseField(
    description="Interval value.",
    default=1,
    filter_type=FilterType.skip,
)
INTERVAL_UNIT = BaseField(
